...
class inst_generator:
    ...
    def get_registers(self):
        reg_list = [str(self.Rd), str(self.Rn), str(self.Rm)]
        return reg_list
...
def test_arm64(ARM64_CODE, output_file, reg_list, nzcv_param):
    ...
    try:
        ...
        output_file.write(
            "Rd_pre=bv[64](0b" + str(bin(Rd_val)[2:].zfill(64)[::-1]) + ")\n")
        if Rn == Rm:
            mu.reg_write(X_regs[Rn], Rn_val)
            output_file.write(
                "Rn_pre=bv[64](0b" + str(bin(Rn_val)[2:].zfill(64)[::-1]) + ")\n")
            # change the logic behind the calculation of NZCV flag
            output_file.write(
                "Rm_pre=bv[64](0b" + str(bin(Rn_val)[2:].zfill(64)[::-1]) + ")\n")
            ...
            # change the logic behind the calculation of NZCV flag
            output_file.write(
                "Rm_pre=bv[64](0b" + str(bin(Rm_val)[2:].zfill(64)[::-1]) + ")\n")
            mu.reg_write(X_regs[Rm], Rm_val)

        output_file.write(
            "R_NZCV_pre=bv[4](0b" + str(bin(int(nzcv_val))[2:].zfill(64))[32:36] + ")" + "\n")
        print(
            "R_NZCV_pre=bv[4](0b" + str(bin(int(nzcv_val))[2:].zfill(64))[32:36] + ")")
        ...
        output_file.write("Rd_post=bv[64](0b" + str(bin(Rd_val)[2:].zfill(64)[::-1]) + ")\n")
        output_file.write("Rn_post=bv[64](0b" + str(bin(Rn_val)[2:].zfill(64)[::-1]) + ")\n")
        output_file.write("Rm_post=bv[64](0b" + str(bin(Rm_val)[2:].zfill(64)[::-1]) + ")\n")
        ...
        output_file.write(
            "R_op_val=bv[64](0b" + str(bin(Rd_val)[2:].zfill(64)[::-1]) + ")" "\n")
        print("R_NZCV_post=bv[4](0b" + str(bin(nzcv_post)[2:].zfill(32)[0:4]) + ")" + "\n")
