...
class pvs_lemma_generator:
    ...
    def generate_pvs_lemma_file(self, post_state, final_address):
        ...
        self.f.write(" : THEORY\n")
        self.f.write("\n\n      BEGIN")
        self.f.write("\n\n      IMPORTING rsl@ldrb_imm, bitvectors@bv_arith_nat\n")
        ...
        self.f.write("\n\n      ldr_1 : Theory = ldrb_imm[p]{{ Diag:= bv[32](0b" + self.input_bitstring + ") }}")
        ...
        self.f.write("\n%|- QED")
        # self.f.write("\n%|- test_2 : PROOF ( ldrb_imm_1 ) QED")

        # self.f.write("\n\n%|- test_* : PROOF (ldrb_imm) QED")
        # self.f.write("\n%|- (ldr-imm-gen)")
        # self.f.write("\n%|- QED\n")
