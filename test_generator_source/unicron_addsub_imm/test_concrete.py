...
import re
import os
import operational_addsub_shift as op
...
class test_concrete:
    ...
    # This is the master file with all the diagrams for creating the abstract theories
     ...
     self.register_value_map = {}	# testcode holds a mapping from the register name to the value/ "Rd:5"
     ...
     self.theory_name = "concrete_test_" + self.inst_file_name.replace(".xml","") + "_" + hexstring.upper()
     self.output_file = "concrete_test_" + self.inst_file_name.replace(".xml","") + "_" + hexstring.upper() + ".pvs"
    ...
    def generate_inst_diagram_pvs(self):
        ...
        self.file_ptr.write("\n\tIMPORTING Basic_ASL_Types, Basic_ASL_Function %bts[32], bt[32]\n")
 	...
 	# testcode
        ...
        self.file_ptr.write("\n%|- v_TCC* : PROOF\n")
	self.file_ptr.write("%|- p1_TCC*: PROOF (eval-formula) QED\n\n")
	self.file_ptr.write("%|- ASL_TCC2: PROOF (then (skosimp*)(subs_addsub_shift_ALS_TCC2)) QED\n\n")
    ...
    def generate_diagram_with_bvec(self, bitstr):
	    ...
	    if field_name == "Rd" or field_name == "Rn" or field_name == "Rm" or field_name == "shift" or field_name == "imm6" :
	    ...
	    if lowbit == "":
		str2 = str2 + field_name + ":= "  + "bv( 0b"+  bitstr[int(hibit)] + " ) ,"
	    else:
            	str2 = str2 + field_name + ":= "  + "bv( 0b"+  bitstr[lowbit_int:int(hibit)+1] + " ) ," 
        str3 = ' length:= 32 #)'
        str4 = str1 + str2 + str3
        return str4
	...
	op_addsub_shift = op.operational_addsub_shift(self.file_ptr, self.register_value_map["shift"], self.register_value_map["imm6"])
