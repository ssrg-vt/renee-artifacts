...
# code to be emulated
ARM64_CODE = b"\xab\x05\x00\xf8\xaf\x05\x40\x38"


 #b"\xab\x05\x00\xb8" # this is str x11, [x13];  #\x00\x00\x00\x8A" #\xaf\x05\x40\x38" 
...
def test_arm64():
    ...
    try:
        ...
        ##mu.reg_write(UC_ARM64_REG_X0, 0x10008)

        # initialize machine registers
        mu.reg_write(UC_ARM64_REG_X7, 0x12345678)
        mu.reg_write(UC_ARM64_REG_X13, 0x199992)
