...
def test_arm64(ARM64_CODE, output_file, reg_list, nzcv_param):
    ...
    try:
        ...
        output_file.write("Rd_pre=bv(0b" + str(bin(Rd_val)[2:].zfill(64)[::-1]) + ")\n")
        # if Rn == Rm:
        ...
        output_file.write("R_NZCV_pre=bv(0b" + str(bin(int(nzcv_val))[2:].zfill(64))[32:36] + ")" + "\n")
        print("R_NZCV_pre=bv(0b" + str(bin(int(nzcv_val))[2:].zfill(64))[32:36] + ")")
