...
class inst_family:
    ...
    # This is the master file with all the diagrams for creating the abstract theories
     ...
     self.extraction_class_name = sys.argv[1]
    ...
    def generate_inst_diagram_pvs(self):
 	...
 	# testcode
        self.file_ptr.write("\n\t" + self.generate_diagram_with_bvec("01000010000000001010000011010111") +"\n")
    ...
    def generate_diagram_with_bvec(self, bitstr):
        ...
        for x in self.fields:
            ...
            if 'width' in x:
                ...
                #print str(x) + "::bt"
                theory_type = "bt"
	    if field_name == "Rd" or field_name == "Rn" or field_name == "Rm":
